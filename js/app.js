    ...
    _createMarkup() {
        ...
        <article class="traking-card">
          <header class="traking-card__header">
            <h4 class="traking-card__title">
              ${title}
            </h4>
            <img class="traking-card__menu" src="./images/icon-ellipsis.svg" alt="menu">
          </header>
          <div class="traking-card__body">
            <div class="traking-card__time">
              ${current}hrs
            </div>
            <div class="traking-card__prev-period">
        ...
        this.time = this.container.querySelector(`.dashboard__item_${id} .traking-card__time`);
        this.prev = this.container.querySelector(`.dashboard__item_${id} .traking-card__prev-period`);
    }
        ...
        .then(data => {
            ...
            selectors.forEach(selector => 
                selector.addEventListener('click', function() {
                    selectors.forEach(sel => sel.classList.remove('view-selector__item_active'))
